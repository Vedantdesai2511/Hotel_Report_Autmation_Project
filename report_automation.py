...
def report_automation():
    ...
    def report_download_automation():
        ...
        #
        # actions.perform() a = driver.find_element_by_xpath('//*[contains(concat( " ", @class, " " ), concat( " ",
        # "CHI_PageSection", " " ))]')
        #
        # time.sleep(1) a.sendKeys(Keys.TAB) time.sleep(0.5) a.sendKeys(Keys.TAB) a.sendKeys(Keys.TAB) a =
        # driver.find_element_by_xpath('//*+[contains(concat( " ", @class, " " ), concat( " ", "CHI_Row", " " ))]//*[
        # contains(concat( " ", @class, " " ), concat( " ", "CHI_Row", " " ))]//input')
    ...
    def email_house_keeping_check_off_list_reports_using_libraries():
        ...
        body = ""
        # root_directory = r'C:\Users\vedan\Downloads\{}.pdf'
        filenames = ['house_keeping_report.pdf', root_directory.format(name_of_the_file_HK_1_ + '.pdf'),
                     root_directory.format(name_of_the_file_HK_2_ + '.pdf')]
    ...
    files = [root_directory.format(name_of_the_file_ + '.pdf'), root_directory.format(name_of_the_file_HK_1_ + '.pdf'),
             root_directory.format(name_of_the_file_HK_2_ + '.pdf'), root_directory.format(name_of_the_file_ + '.csv')]
